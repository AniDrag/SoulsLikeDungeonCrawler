...
namespace AniDrag.UI
{
    public class OpenCloseWindow : MonoBehaviour
    {
        ...
        private Coroutine _animateWindowCorutne;
        ...
        private void OnValidate()
        {
            if (window != null)
            {
                windowRectTransform = window.gameObject.GetComponent<RectTransform>();
                windowCanvasGroup = window.gameObject.GetComponent<CanvasGroup>();
            }
        ...
        private void InitializeOffsetPositions()
        {
            ...
            _downOffset = new Vector2(0, -distanceToAnimate.y);   // negative for down

            _rightOffset = new Vector2(distanceToAnimate.x, 0);
            _leftOffset = new Vector2(-distanceToAnimate.x, 0);   // negative for left
        }


        [ContextMenu(itemName: "Toggle Open Close")]
        [Button("Toggle Open Close", ButtonSize.Large, 20, .3f, .5f, .9f, SdfIconType.ToggleOn)]
        ...
        [ContextMenu(itemName: "Open Window")]
        ...
        public void OpenWindow()
        {
            ...
            if(_animateWindowCorutne != null) StopCoroutine( _animateWindowCorutne );
        
            _animateWindowCorutne = StartCoroutine(AnimateWindow(true));
        }
        [ContextMenu(itemName: "Close Window")]
        ...
        public void CloseWindow()
        {
            ...
            _animateWindowCorutne = StartCoroutine(AnimateWindow(false));
        }
        ...
        private void RecalculateGizmoPositions()
        {
            ...
            _windowInitialPositionForGizmos = new Vector2(window.transform.position.x, window.transform.position.y) + windowRectTransform.rect.center;
            _windowOpenPositionForGizmos = _windowInitialPositionForGizmos + GetOffset(openDirection);
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Gizmos.DrawWireCube(_windowInitialPositionForGizmos, windowRectTransform.sizeDelta);
        ...
        private void DrawIndicators()
        {
            ...
            Gizmos.DrawLine(_windowInitialPositionForGizmos, _windowOpenPositionForGizmos);
